#!/usr/bin/env python3
"""Build list of shows from humorbd.sql.

Shows are MODX resources with parent = 33.
We output a json list with fields needed for incremental import.

Usage:
  python3 build_shows_list.py --sql /app/humorbd.sql --out /app/migration/shows/shows_list.json
"""
...
def main():
    ...
    parser.add_argument("--out", default="/app/migration/shows/shows_list.json")
    parser.add_argument("--parent", type=int, default=33)
    ...
    print(f"Saved {len(results)} shows to {args.out}")
