...
3. **Людей в БД почти нет** (3), хотя составы (3754 записи) и роли жюри (495 имён) уже ссылаются на них по имени/slug старого сайта. В `migration/people_list.json` — 1044 человека со старого сайта; после их заведения связи проставятся автоматически.
